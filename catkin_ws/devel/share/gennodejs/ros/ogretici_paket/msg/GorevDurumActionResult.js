...
class GorevDurumActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new GorevDurumResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GorevDurumResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += GorevDurumResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GorevDurumActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = GorevDurumResult.Resolve(msg.result)
    }
    else {
      resolved.result = new GorevDurumResult()
    }
...
module.exports = GorevDurumActionResult;
